...
const HeroSection = () => {
  return (
    <section className="pt-20 px-4 sm:px-6 overflow-hidden bg-gradient-to-b from-boost-purple/90 to-boost-deep-purple/90 text-white">
      {/* Background Elements */}
      ...
      <div className="container mx-auto py-12 md:py-16">
        <div className="max-w-4xl mx-auto text-center space-y-6 md:space-y-8">
          <div className="flex justify-center">
            <span className="text-boost-orange text-6xl md:text-7xl font-bold">*</span>
          </div>
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold leading-tight animate-slide-down opacity-0" style={{
            animationDelay: "0.1s"
          }}>
